...
<!-- Mirrored from themewagon.github.io/SEODash/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 12:31:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>SeoDash Free Bootstrap Admin Template by Adminmart</title>
  <link rel="shortcut icon" type="image/png" href="assetdashboard/images/logos/seodashlogo.png" />
  <link rel="stylesheet" href="assetdashboard/css/styles.min.css" />
</head>
...
<body>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="index-2.html" class="text-nowrap logo-img">
            <img src="assetdashboard/images/logos/logo-light.svg" alt="" />
          </a>
          ...
          <div class="unlimited-access hide-menu bg-primary-subtle position-relative mb-7 mt-7 rounded-3">
            <div class="d-flex">
              ...
              <div class="unlimited-access-img">
                <img src="assetdashboard/images/backgrounds/rocket.png" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </nav>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="assetdashboard/images/profile/user-1.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body text-center">
              <img src="assetdashboard/images/backgrounds/product-tip.png" alt="image" class="img-fluid" width="205">
          ...
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="assetdashboard/images/blog/blog-img1.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="assetdashboard/images/profile/user-3.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
            </div>
        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="assetdashboard/images/blog/blog-img2.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="assetdashboard/images/profile/user-2.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
            </div>
            <div class="card-body p-4">
        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="assetdashboard/images/blog/blog-img3.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="assetdashboard/images/profile/user-3.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
  ...
  <script src="assetdashboard/libs/jquery/dist/jquery.min.js"></script>
  <script src="assetdashboard/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <script src="assetdashboard/libs/apexcharts/dist/apexcharts.min.js"></script>
  <script src="assetdashboard/libs/simplebar/dist/simplebar.js"></script>
  <script src="assetdashboard/js/sidebarmenu.js"></script>
  <script src="assetdashboard/js/app.min.js"></script>
  <script src="assetdashboard/js/dashboard.js"></script>
  <script src="../../cdn.jsdelivr.net/npm/iconify-icon%401.0.8/dist/iconify-icon.min.js"></script>
</body>


<!-- Mirrored from themewagon.github.io/SEODash/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 12:31:25 GMT -->
</html>

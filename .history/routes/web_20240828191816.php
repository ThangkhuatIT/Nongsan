...
Route::middleware()->prefix('admin')->group(function () {
    Route::get('/management/News', [UserController::class, 'newsManage'])->name('admin.management.news');
    Route::get('/management/News/createNews', [UserController::class, 'createNewsIndex'])->name('admin.management.createnews');

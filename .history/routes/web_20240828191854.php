...
Route::middleware()->prefix('admin')->group(function () {
    Route::get('/management/blogs', [UserController::class, 'newsManage'])->name('admin.management.news');
    Route::get('/management/blogs/createBlog', [UserController::class, 'createNewsIndex'])->name('admin.management.createnews');
    // Route::post('/management/News/createNews', [AdminController::class, 'createNews'])->name('admin.management.doCreatenews');
});

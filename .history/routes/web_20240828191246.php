...
Route::middleware()->prefix('admin')->group(function () {
    Route::get('/management/News', [AdminController::class, 'newsManage'])->name('admin.management.news');
    Route::get('/management/News/createNews', [AdminController::class, 'createNewsIndex'])->name('admin.management.createnews');
